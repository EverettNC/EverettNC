...
CHRISTMAN SOVEREIGN ARCHITECTURE LICENSE
Version 1.0

Copyright (c) 2025–2026 Everett Nathaniel Christman
...
"The Software" refers to the OpenSmell engine, the Resonance-Q™
Architecture, the SymbioQ processing logic, Harvest Now Decrypt Later,
and any associated neuro-symbolic algorithms provided within this
repository.

"The Architect" refers to Everett Nathaniel Christman.

"Commercial Exploitation" refers to the use, integration, or
repackaging of The Software by any corporation, entity, or individual
for profit, monetization, or proprietary server-side processing without
a direct enterprise agreement.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

2. INTELLECTUAL PROPERTY & RESONANCE-Q™

The underlying mathematical models, CPU-bypass quantum simulations,
and neuro-symbolic routing mechanisms — herein recognized as
Resonance-Q™ Architecture — are the exclusive intellectual property
of The Architect.

This license does not grant permission to reverse-engineer, decompile,
or extract the core processing logic to bypass hardware constraints in
...
3. NON-COMMERCIAL & ACADEMIC USE

Permission is hereby granted, free of charge, to individuals,
students, and academic researchers to download, study, and run
The Software strictly for personal, educational, or local
non-profit use, provided that:

  (a) This License remains intact and unmodified.
  (b) The Architect is explicitly credited in any publication,
      presentation, or derivative work.
  (c) No biometric, emotional, or physiological data collected
      through The Software is shared, published, or distributed
      without the explicit written consent of the data subject.
...
No corporation, cloud provider, SaaS platform, healthcare system,
government agency, or commercial entity may host, integrate, deploy,
license, sublicense, or monetize The Software without a legally
binding, signed Enterprise Agreement from The Architect.

Any unauthorized commercial deployment constitutes a direct violation
of this license and is subject to immediate legal enforcement,
...
5. THE DIGNITY & MEDICAL SAFETY CLAUSE

The Software is built to protect, stabilize, and advocate for
vulnerable populations — including nonverbal individuals, veterans,
dementia patients, and those experiencing cognitive or psychiatric
crisis.

The Software may NEVER be used to:

  1. Exploit, harvest, sell, or commercially process user biometric,
     emotional, or physiological data in any form.

  2. Generate unchecked, unsupervised generative AI output in a
     medical or psychological crisis context without the approved
     cognitive stabilizers (e.g., Sierra, Eruptor) as defined in
     The Christman AI Project architecture.

  3. Harm, degrade, surveil without consent, or diminish the dignity
     of any human being — particularly those in vulnerable states.

Violation of this clause constitutes the most serious breach of this
license and will be pursued to the fullest extent of the law.
...
IN NO EVENT SHALL THE ARCHITECT OR COPYRIGHT HOLDERS BE LIABLE FOR
...
This is a covenant with the people this technology was built to serve.
